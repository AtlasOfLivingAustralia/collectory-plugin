...
//        }
    ...
    def show = {
        ...
        if (params.id instanceof String && params.id.startsWith(Institution.ENTITY_PREFIX)) {
            ...
            if (!collectionInstance) {
                ...
                //ActivityLog.log authService?.username(), authService?.userInRole(grailsApplication.config.auth.admin_role), collectionInstance.uid, Action.VIEW
    ...
    def showDataProvider = {
        ...
        if (!instance) {
            ...
            ActivityLog.log authService?.getUserId(), authService?.userInRole(grailsApplication.config.auth.admin_role), instance.uid, Action.VIEW
            [instance: instance]
        }
    }
